...
export default function Home() {
  return (
    <div className="lg:px-10 px-5 pb-3 pt-5 relative font-poppins">
      <Navbar />
      <img src={shapes} className="absolute top-0 right-0 w-28 -z-10" />
      <div className="flex flex-wrap lg:mt-24 mt-20 md:space-x-28">
        <div className="lg:w-2/5 w-full flex flex-col lg:justify-normal justify-center items-center lg:items-start">
          <div>
            ...
            <img
              src={underline}
              alt="Underline Pic"
              className=" lg:w-1/4 w-full mt-1"
            />
          </div>
          <div className="mt-8 text-sm font-medium text-center lg:text-left px-4 lg:px-0">
            <p>
          ...
          <div
            className="mt-14 bg-dark-green py-2.5 w-32 text-white rounded-md text-xs text-center font-semibold cursor-pointer"
            onClick={() => console.log("CLicked")}
          >
            GET STARTED
          </div>
        </div>
        <div className="w-2/4 relative hidden lg:flex">
      ...
      <div className="flex w-full md:flex-nowrap flex-wrap justify-between md:space-x-10 mt-14 px-5">
